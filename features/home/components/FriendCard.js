...
const FriendCard = ({ friend }) => {
  const { name, profilePic, category, joined, status } = friend;
  return (
    <div className="col-span-1 flex flex-col justify-center items-center w-full border rounded-xl py-5 gap-2 border-zinc-200">
